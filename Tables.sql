...
foreign key(nomeSquadra1,categoriasq1) references Squadra(nome, categoria) on delete  no action on update cascade,
foreign key(nomeSquadra2,categoriasq2) references Squadra(nome, categoria) on delete  no action on update cascade,
primary key(idEv),
